...
// UIDAI Offline eKYC signing certificate (RSA-2048, valid until 2029)
const uidaiPublicKey = `-----BEGIN CERTIFICATE-----
...
createRoot(document.getElementById("root")!).render(
  <StrictMode>
    <AnonCitizenProvider config={config} publicKey={uidaiPublicKey}>
      <App />
    </AnonCitizenProvider>
  </StrictMode>
);
