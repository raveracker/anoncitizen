/**
 * @module @anoncitizen/react-native/hooks
 * React hooks for AnonCitizen proof generation and verification (React Native).
 * API-identical to @anoncitizen/react hooks.
 */
 ...
 *       onPress={() => generate({ qrData, nullifierSeed: 42n })}
 *       disabled={status === "generating"}
 *     />
 *     {status === "generating" && <Text>Generating proof...</Text>}
 *     {status === "complete" && <Text>Proof ready!</Text>}
